...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field students on 'OfferedCourse'
        db.create_table(u'page_offeredcourse_students', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offeredcourse', models.ForeignKey(orm[u'page.offeredcourse'], null=False)),
            ('student', models.ForeignKey(orm[u'account.student'], null=False))
        ))
        db.create_unique(u'page_offeredcourse_students', ['offeredcourse_id', 'student_id'])

        # Adding field 'Page.image'
        db.add_column(u'page_page', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field students on 'OfferedCourse'
        db.delete_table('page_offeredcourse_students')

        # Deleting field 'Page.image'
        db.delete_column(u'page_page', 'image')
